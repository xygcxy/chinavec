...
<div id="reg_setp">
	...
	<div id="setp_quicklogin">
    	<form action="regProcess.php" method="post" id="reg_form">
            ...
            <div class="loginbtn">
			<input type="button" name="regbtn" id="regbtn" value="注册" disabled="disabled" onclick="register()" /> <!--add by ligang-->
			<input type="button" name="refresh" class="refresh" value="重置" onclick="reg_refresh()"  /> <!--add by ligang-->	
            </div>
        </form>
