...
<?php 
		...
		$sql="select * from photo_wall WHERE `id` = $id";
		$result=mysql_query($sql);
		$row=mysql_fetch_object($result);
		$photo='../../chinavec_campus'.$row->photo_url;
		//print_r($photo);
		//exit;
		switch($row->photo_type_id)
                         {
			  case 1:
                            $Type= "新锐导演";
                            break;
...
<?php include "common/table.php";?>
    	...
    	<div id="movieTitle">
            ...
            <p style="color:#FFFFFF; font-size:15px;"><?php echo $row->name;?>
            &nbsp;&nbsp;
...
<!--movieDetail Start-->        
    ...
    <div class="movieDetail"> 
		...
		<div class="movieDetail2">
            <div style="width:900px;margin:25px 10px 0px 30px;float:left;">
                <br/>
                ...
                <div class="p_half">
                    ...
                    <img width="180px" height="250px" src="<?php echo $photo;?>">
                    </img><br/></div>
                    <div style=" margin-top:30px; margin-left:50px; width:500px; float:left"> 
                    <span style="margin:auto"  />姓名：<?php echo $row->name;?><br/><br/>
		            <span style="margin:auto" name="svideo" value="{$result_row['id']}" />身份：<?php echo $Type;?><br/><br/>
                    <span style="margin:auto" name="svideo" value="{$result_row['id']}" />个人简介：<?php echo $row->abstract;?><br/><br/>
                    <span style="margin:auto" name="svideo" value="{$result_row['id']}" />邮箱：<?php echo $row->mail;?><br/><br/>
                    <span style="margin:auto" name="svideo" value="{$result_row['id']}" />微信：<?php echo $row->wechat;?><br/><br/>
                    <span style="margin:auto" name="svideo" value="{$result_row['id']}" />QQ：<?php echo $row->QQ;?><br/><br/>
                    <span style="margin:auto" name="svideo" value="{$result_row['id']}" />星座：<?php echo $row->star;?><br/><br/>
                    <span style="margin:auto" name="svideo" value="{$result_row['id']}" />血型：<?php echo $row->blood_type;?><br/><br/>
                    <!--<span style="margin:auto" name="svideo" value="{$result_row['id']}" />联系方式：<?php echo $row->mp;?>--><br/><br/>
                    
                	</div><br/>
                    <div style="clear:both"></div><br/><br/><br/>
                    <a style="margin-left:15px" href="teachersmore.php">返回</a><br/><br/>
            </div></div></div></div>
