...
<?php include "common/table.php";?>
    	...
    	<div id="movieTitle">
            ...
            <p style="color:#FFFFFF; font-size:15px;">&nbsp;微元素 Micro elements
            &nbsp;&nbsp;
  ...
  //$sql = "SELECT * FROM `video`";
          ...
          $nums = mysql_num_rows($result); 
           ...
           <div style="width:200px; height:160px; margin:10px 20px 5px 22px; float:left; border-radius: 5px;">    
			...
			否则 $poster = 0.jpg*/
			$file ='./chinavec/data-storage/poster/h'.$row['id'].".jpg";
			if(file_exists($file)){
				$poster = $row['id'].".jpg";
				//echo $poster;
				//exit;
		...
		?>
                    <center><img src="<?php echo $config['posterH'];echo $poster;?>" width="170px" height="100px" /></center>
                	</a>
                </div>
