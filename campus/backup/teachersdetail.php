...
<?php 
		...
		$photo='../../chinavec_cd/campusadmin'.$row->photo_url;
		//print_r($photo);
		//exit;
	?>
		...
		<div class="movieDetail2">
            <div style="width:900px;margin:25px 10px 0px 30px;float:left;">
                ...
                <div class="p_half">
		            ...
		            <span style="margin:auto" name="svideo" value="{$result_row['id']}" />职位：<?php echo $row->abstract;?><br/><br/>
                    <span style="margin:auto" name="svideo" value="{$result_row['id']}" />个人简介：<?php echo $row->abstract;?><br/><br/>
                    <span style="margin:auto" name="svideo" value="{$result_row['id']}" />联系方式：<?php echo $row->abstract;?><br/><br/>
                	</div><br/>
                    <div style="clear:both"></div><br/><br/><br/>
                    <a style="margin-left:15px" href="campus.php">返回</a><br/><br/>
            </div></div></div></div>
