  ...
  while ($result_row = mysql_fetch_assoc($result)) {
    ...
    echo <<<TB
	  ...
	  <a href="teachersdetail.php?id={$result_row['id']}" class="font-hui14cu"/>
		  ...
		  <span style="margin:auto" name="svideo" value="{$result_row['id']}" />身份：$Type<br/>
...
TB;
      ...
      ?>
		...
		$page = ceil($numss/$page_num);
            if ($page_no >= 1) {
		    echo "&nbsp;&nbsp;<a href ='teachersmore.php?page_no= 1'>首页 &nbsp;&nbsp;</a>";}
		if($page_no > 1){
                    echo "&nbsp;&nbsp;<a href ='teachersmore.php?page_no=".($page_no-1)."'>上一页</a>&nbsp;&nbsp;&nbsp;";
                }else{
                    echo '<span>上一页</span>&nbsp;&nbsp;&nbsp;';
                }
                ...
                if ($nums == $page_num) {
                    ...
                    echo "&nbsp;&nbsp;&nbsp;<a href ='teachersmore.php?page_no=".($page_no+1)."' >下一页</a>";
		    echo "&nbsp;&nbsp;<a href ='teachersmore.php?page_no= ".$page."'>尾页</a>";
                }else{
                    echo '&nbsp;&nbsp;&nbsp;<span>下一页</span>';
