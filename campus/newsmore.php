...
<?php include "common/table.php";?>
    	...
    	<div id="movieTitle">
            ...
            <p style="color:#FFFFFF; font-size:15px;">新闻资讯 M-News
            &nbsp;&nbsp;
...
<!--movieDetail Start-->        
    ...
    <div class="movieDetail"> 
        ...
        <img src="img/laba.jpg" width="120px";/>
        </div>
           <div style="width:300px;height:200px;margin-top:80px; margin-left:70px;float:left;"> 
                       <?php
        ...
        if (!isset($_GET['page_no']))//page_no 空
          ...
          $sql = "SELECT * from `college` where `college_type_id`=3 limit $start_num, 10";
...
TXTE;
            ...
            <div style="width:300px;  margin-top:80px; margin-left:30px;float:left;"> 
            <?php

			$sql="SELECT * FROM  `college`  where `college_type_id`=3 limit 10,$page_num";
			$result=mysql_query($sql);		
			while($row=mysql_fetch_array($result)){
             echo <<<TXTE
...
<?php
		/*
		$sql1 = "SELECT * from `college` where `college_type_id`=3";
		$result1 = mysql_query($sql1);
		$numss = mysql_num_rows($result1);
		$page = ceil($numss/$page_num);
            if ($page_no >= 1) {
		    echo "&nbsp;&nbsp;<a href ='newsmore.php?page_no= 1'>首页&nbsp;&nbsp;</a>";}
		if($page_no > 1){
                    echo "&nbsp;&nbsp;<a href ='newsmore.php?page_no=".($page_no-1)."'>上一页</a>&nbsp;&nbsp;&nbsp;";
                }else{
                    echo '<span>上一页</span>&nbsp;&nbsp;&nbsp;';
                }
                ...
                if ($nums == $page_num) {
                    ...
                    echo "&nbsp;&nbsp;&nbsp;<a href ='newsmore.php?page_no=".($page_no+1)."' >下一页</a>";
		    echo "&nbsp;&nbsp;<a href ='newsmore.php?page_no= ".$page."'>尾页</a>";
                }else{
                    echo '&nbsp;&nbsp;&nbsp;<span>下一页</span>';
